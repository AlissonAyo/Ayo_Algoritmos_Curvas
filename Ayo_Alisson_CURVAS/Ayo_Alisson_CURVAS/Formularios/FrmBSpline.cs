...
namespace Ayo_Alisson_CURVAS.Formularios
{
    public partial class FrmBSpline : Form
    {
        ...
        {
            curva.EstablecerGrado((int)numGrado.Value);
            DibujarTodo();
        }
        ...
        private void DibujarTodo()
        {
            ...
            if (puntos.Count > (int)numGrado.Value)
            {
        ...
        private void FrmBSpline_Resize(object sender, EventArgs e)
        {
        ...
        private void listBoxPuntos_SelectedIndexChanged(object sender, EventArgs e)
        {
